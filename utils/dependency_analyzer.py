...
import os
from data.configuration import d4j_home, proxy_host, proxy_port, proxy_username, proxy_password, d4j_proj_base
...
if __name__ == '__main__':
    # get actual xml file path given xmls name in xmls dict
    # xml_paths = {}
    # for key, value in xmls.items():
    #     # get all dir name in d4j_proj_base
    #     dirs = os.listdir(d4j_proj_base)
    #     for dir in dirs:
    #         if key in dir:
    #             # get the actual xml file path of both fixed and buggy version
    #             xml_paths
    #
    #
    for project in xmls:
